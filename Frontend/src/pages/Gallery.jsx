...
const galleryPhotos = [
    ...
    { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAgT_hg800pBQY1Wa1JmYdY_rC4nav0fj2sAMadsEoaz35wr6L9DmPoADB0ZomxPHIQGoq6CN7yJk8Mtvwt7qVi9wsd-7qBCbspEP-djYMZSSEoWYTF-x2yIHfFlg-NHF7TPmLnbfyEEMwWXDVJ5QJprlVk2nCb0lr7TlVCxw6e3ZKk8leD7_HwHr3bG2M3i6odbXn0f1Wy1SsXrS-zACfLyt3-9dLxlHxUdVo4t-GfYCAOa0moBxlkfFWufsrvYTSvqdD8SgRTYGFs', reveal: 'data-reveal-right' },
    { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBR5pf7TReMMBZXHGe0GKHnogXAJd-R5U5okO05Y0m47zDfIQXAo2J_dA0HoxEz9t4xLCu1EucxwWwdvW9aSaRVYDwKDsMh304ZkTNwz7QP9L4A5vhikxjGu6o1DHdqL_Znda1Azr0ai9kbmae3t2L1IkvvC6-VQgJwX8bzESls5DsbevIscrMiL9iok8MNJzuzF4anEnPSafEwcVNZbjHpTOojWDAqH4Xgu1PvKU-URaIwge_JxXa84ixsVQmnkn_qeSOXnCRg0B85', reveal: 'data-reveal-flip' },
    { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCwhO09i81tMyCYNiZXqEHEs9ka7ihgQ4vYetISlLF2JjKhNDszS6QWlBiBKCOwDZgqJkCDlVEObljJVJrOR7gq81-9E80pADUK_zfJlIwTr1uVf3-j6O4CsQZG6L4inO-0-v-Zl60Mj8jqUf0yWTulFH-YWWa9qO0XRcHkQqTmJr-VMWv3eLIGQsDtgLO_Hwk7oFmwl3y2lFt4ol_k_KoSnt8TEST1ZX2S3IddKSHBDzH1Vs3MbmY3-K8_ZKz7KZKwO14-8nzTXZPI', reveal: 'data-reveal-bounce' },
    { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAAR9GTYHL0XoBpCnByjLrtcWQDK7X-gUyS9FVvy9jYLiOoD4ymdT7GSzRwdcMhLh4-HA0OFJH1G9ayeIjLHT9oXYAt_5hicIs7PVBlhtwwLnrs46sgBpjN8Z6b2HUNvILywdIQhRXpcWY_nh5ae39DISdsvbfdqwVGtcAzLtOJpG_ulyB7p1ftNFvhHHOgOILP8sX90HVz3oHIQp2TUs_EDH89rmq7hWJnubrqQy7loU9xCrqv-3nWfrrKJ58EPaE3kcM-XNjxUbAy', reveal: 'data-reveal-spin' },
    { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCGy4YWJ_7pE4d-9TgXz9AGX5Do8t89PWWPHEf18ZujMAbyMKr4oWYQnI8H_Q8gzUI6XYuvK8jDxb4JZ5CZVXPB0HAbdPSqnlfyCV6GVzT4XVHjhKfNLAcaJbdrXEaIzHsLh3XZ_qFT4xIGoTPY7pDqgTBnvMJ5XVkK7JUFkhMK-RVbJF9Hgwo2CX9i2MG3yDWpHftbZiD_9-c1WNdsZi3dH0RAh2cf4pQF-KsnyAlSxwFnUGuuoU--gLorhRpNkYMlP9hSzw9Wedo9', reveal: 'data-reveal-left' },
    { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDiFp6Nv9HQK8JMgy_cvZMl2YmkcrusObqEl0T-0Utz_8oSVTZgma-xfB9PGr1FWpfaTejdgrUWgC6QW705s7_ae16dBqGOeyXxxudijlIxfTgKKEdjMN7n1q7wXcwYhE3GBLfbao78by3SA2E7qK8l0Os4bRnLhApjJs3zsFfCvdWQFPvhWFevFJk71K9Av7e2wUoCBNvzHP7OijaaGAayhXwJ5S_WmSZrm2-RtCSB8snf17X2ut1Ikphu8MN0dauMOrFWJdCDiWTb', reveal: 'data-reveal-right' },
];
        ...
        <>
            ...
            <section className="max-w-[1200px] mx-auto px-5 md:px-16 mb-20">
                <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
                    {galleryPhotos.map(({ src, reveal }, i) => (
                        <div
                            key={i}
                            {...{ [reveal]: '' }}
                            data-delay={i * 80}
            ...
            {lightbox && (
                ...
                >
                    <div className="relative max-w-5xl w-full mx-4 animate-fade-in-up">
                        <img src={lightbox} alt="Gallery full" className="w-full rounded-2xl shadow-2xl max-h-[85vh] object-contain" />
                        <button
